...
public class JsonDictionaryStringObjectConverter : JsonConverter<IDictionary<string, object?>>
{
    ...
    public override void Write(
        Utf8JsonWriter writer, IDictionary<string, object?> value, JsonSerializerOptions options)
    {
